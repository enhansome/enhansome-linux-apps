...
* [Audacity](https://github.com/audacity/audacity) ⭐ 18,357 | 🐛 1,780 | 🌐 C++ | 📅 2026-09-08 - Free, open source, cross-platform software for recording and editing sounds. 👏
* [LMMS](https://github.com/LMMS/lmms) ⭐ 10,347 | 🐛 1,454 | 🌐 C++ | 📅 2026-09-05 - Free cross-platform music production software. 👏
* [Ardour](https://github.com/Ardour/ardour) ⭐ 5,267 | 🐛 47 | 🌐 C++ | 📅 2026-09-08 - Free, open source audio workstation for recording, editing and Mixing. 👏
...
* [restic](https://github.com/restic/restic) ⭐ 35,933 | 🐛 593 | 🌐 Go | 📅 2026-09-01 - Fast, secure, efficient backup program. 👏
* [bup](https://github.com/bup/bup) ⭐ 7,338 | 🐛 17 | 🌐 Python | 📅 2026-09-04 - Efficient backup system, provide fast incremental saves and global deduplication. 👏
* [backup](https://github.com/backup/backup) ⭐ 4,856 | 🐛 6 | 🌐 Ruby | 📅 2024-07-03 - Powerful backup tool distributed using RubyGems. 👏
* [Back In Time](https://github.com/bit-team/backintime) ⭐ 2,665 | 🐛 141 | 🌐 Python | 📅 2026-09-02 - Simple backup solution. 👏
* [BackupPC](https://github.com/backuppc/backuppc) ⭐ 1,625 | 🐛 52 | 🌐 Perl | 📅 2026-05-31 - High-performance, enterprise-grade system for backing up to a server's disk. 👏
...
* [Chromium](https://github.com/chromium/chromium) ⭐ 24,740 | 🐛 28 | 📅 2026-09-08 - Open source, safer, faster and more stable way for all Internet users. 👏
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 191,499 | 🐛 20,691 | 🌐 TypeScript | 📅 2026-09-08 - Free, open source, powerful and runs everywhere. 👏
* [neovim](https://github.com/neovim/neovim) ⭐ 102,226 | 🐛 1,898 | 🌐 Vim Script | 📅 2026-09-08 - Vim-fork focused on extensibility and usability. 👏
* [Atom](https://github.com/atom/atom) ⚠️ Archived - Hackable text editor for the 21st Century. 👏
* [Vim](https://github.com/vim/vim) ⭐ 40,872 | 🐛 1,633 | 🌐 Vim Script | 📅 2026-09-08 - Greatly improved version of the good old UNIX editor Vi. 👏
...
* [Kakoune](https://github.com/mawww/kakoune) ⭐ 11,048 | 🐛 916 | 🌐 C++ | 📅 2026-09-06 - Modal editor with multi selection and fewer keystroke 👏
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,696 | 🐛 3,368 | 🌐 Java | 📅 2026-09-08 - Free universal database tool and SQL client. 👏
* [CockroachDB](https://github.com/cockroachdb/cockroach) ⭐ 32,447 | 🐛 8,466 | 🌐 Go | 📅 2026-09-02 - CockroachDB is a distributed SQL database built on a transactional and strongly-consistent key-value store. 👏
* [DB Browser for SQLite](https://github.com/sqlitebrowser/sqlitebrowser) ⭐ 24,577 | 🐛 838 | 🌐 C++ | 📅 2026-09-08 - High quality, visual, open source tool with SQLite. 👏
...
* [Postbird](https://github.com/Paxa/postbird) ⭐ 1,639 | 🐛 53 | 🌐 JavaScript | 📅 2025-06-30 - Cross-platform PostgreSQL GUI client, written in JavaScript, runs with Electron. 👏
...
* [Krita](https://github.com/KDE/krita) ⭐ 10,339 | 🐛 0 | 🌐 C++ | 📅 2026-09-08 - Open source professional software and free digital painting. 👏
* [GIMP](https://github.com/GNOME/gimp) ⭐ 6,401 | 🐛 0 | 🌐 C | 📅 2026-09-08 - Free & Open Source Image Editor. 👏
* [Pinta](https://github.com/PintaProject/Pinta) ⭐ 4,023 | 🐛 227 | 🌐 C# | 📅 2026-09-07 - Free, open source program for drawing and image editing. 👏
* [Inkscape](https://github.com/inkscape/inkscape) ⭐ 3,873 | 🐛 1 | 📅 2022-03-03 - Professional vector graphics editor. 👏
* [MyPaint](https://github.com/mypaint/mypaint) ⭐ 2,971 | 🐛 225 | 🌐 Python | 📅 2026-06-16 - Fast and dead-simple painting app for artists. 👏
...
* [Mailspring](https://github.com/Foundry376/Mailspring) ⭐ 17,779 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-08 - Free, open source, beautiful and fast mail client. 👏
* [Thunderbird](https://www.thunderbird.net) - Free email application, easy to install and customize.

## Markdown Editors

* [ghostwriter](https://github.com/wereturtle/ghostwriter) ⭐ 4,980 | 🐛 22 | 🌐 C++ | 📅 2026-09-06 - Cross-platform, aesthetic, distraction-free Markdown editor. 👏
* [Moeditor](https://github.com/Moeditor/Moeditor) ⚠️ Archived - Your all-purpose Markdown editor. 👏
* [ReText](https://github.com/retext-project/retext) ⭐ 2,052 | 🐛 76 | 🌐 Python | 📅 2026-08-30 - Simple but powerful editor for Markdown and reStructuredText. 👏
* [Remarkable](https://github.com/jamiemcg/remarkable) ⭐ 2,038 | 🐛 80 | 🌐 Python | 📅 2024-09-22 - Open source, lightweight and powerful Markdown editor. 👏
...
* [cmus](https://github.com/cmus/cmus) ⭐ 6,236 | 🐛 219 | 🌐 C | 📅 2026-08-12 - Small, fast and powerful console music player for Unix-like operating systems. 👏
* [Clementine](https://github.com/clementine-player/Clementine) ⭐ 4,247 | 🐛 2,440 | 🌐 C++ | 📅 2026-09-01 - Cross-platform music player and library organizer forked from Amarok 1.4. 👏
...
* [Rhythmbox](https://github.com/GNOME/rhythmbox) ⭐ 243 | 🐛 0 | 🌐 C | 📅 2026-09-06 - Music playing application for GNOME. 👏
* [Amarok](https://github.com/KDE/amarok) ⭐ 214 | 🐛 0 | 🌐 C++ | 📅 2026-09-08 - Powerful music player for Linux with an intuitive interface. 👏
...
* [Tagspaces](https://github.com/tagspaces/tagspaces) ⭐ 5,272 | 🐛 78 | 🌐 TypeScript | 📅 2026-07-24 - Offline, open source and data manager. 👏
* [Simplenote](https://github.com/Automattic/simplenote-electron) ⭐ 5,268 | 🐛 280 | 🌐 TypeScript | 📅 2026-09-08 - Light, clean and free. 👏
* [Turtl](https://github.com/turtl/desktop) ⭐ 732 | 🐛 65 | 🌐 JavaScript | 📅 2026-05-22 - Secure and collaborative notebook. 👏
...
* [Fzf command-line fuzzy finder](https://github.com/junegunn/fzf) ⭐ 82,871 | 🐛 329 | 🌐 Go | 📅 2026-09-08 - General-purpose command-line fuzzy finder that makes searching in history way easier. 👏
* [Alacritty](https://github.com/jwilm/alacritty) ⭐ 65,660 | 🐛 339 | 🌐 Rust | 📅 2026-08-31 - Cross-platform, GPU-accelerated terminal emulator. 👏
* [Tmux](https://github.com/tmux/tmux/) ⭐ 49,152 | 🐛 35 | 🌐 C | 📅 2026-09-08 - Tmux is a terminal multiplexer, like screen, but much better. 👏
* [Hyper](https://github.com/zeit/hyper) ⭐ 44,729 | 🐛 1,046 | 🌐 TypeScript | 📅 2026-08-21 - Terminal built on web technologies. 👏
* [Kitty](https://github.com/kovidgoyal/kitty) ⭐ 34,830 | 🐛 11 | 🌐 Python | 📅 2026-09-08 - Fast, feature-rich, cross-platform, GPU based terminal. 👏
* [Upterm](https://github.com/railsware/upterm) ⚠️ Archived - Terminal emulator for the 21st century. 👏
* [Tilix](https://github.com/gnunn1/tilix/) ⭐ 5,717 | 🐛 456 | 🌐 D | 📅 2026-07-01 - Tiling terminal emulator using GTK+ 3. 👏
* [Termite](https://github.com/thestinger/termite) ⚠️ Archived - A keyboard-centric VTE-based terminal. 👏
* [Terminator](https://github.com/gnome-terminator/terminator) ⭐ 2,652 | 🐛 167 | 🌐 Python | 📅 2026-09-07 - Multiple terminals in one window. 👏
* [Tilda](https://github.com/lanoxx/tilda) ⭐ 1,340 | 🐛 157 | 🌐 C | 📅 2026-01-10 - Easy to configure the hotkeys and change the appearance. 👏
* [Certificate Ripper](https://github.com/Hakky54/certificate-ripper) ⭐ 924 | 🐛 1 | 🌐 Java | 📅 2026-09-07 - A CLI tool to extract server certificates from a URL. 👏
* [Konsole](https://github.com/KDE/konsole) ⭐ 699 | 🐛 0 | 🌐 C++ | 📅 2026-09-08 - Terminal emulator for the K Desktop Environment. 👏
* [st](https://st.suckless.org/) - Simple terminal implementation for X. 👏

## Utilities

* [OpenTypeless](https://github.com/tover0314-w/opentypeless) ⭐ 506 | 🐛 38 | 🌐 Rust | 📅 2026-09-08 - Cross-platform AI voice typing app that turns speech into polished text in any app. 👏
* [CrossMacro](https://github.com/alper-han/CrossMacro) ⭐ 395 | 🐛 7 | 🌐 C# | 📅 2026-09-08 - Cross-platform mouse and keyboard macro recorder, player, editor, and text expansion tool with Wayland and X11 support. 👏

## Version Control

* [ungit](https://github.com/FredrikNoren/ungit) ⭐ 10,601 | 🐛 238 | 🌐 JavaScript | 📅 2026-09-03 - Clean and intuitive UI, running on the web. 👏
* [Git Extensions](https://github.com/gitextensions/gitextensions) ⭐ 8,554 | 🐛 595 | 🌐 C# | 📅 2026-09-07 - Standalone UI tool for managing git repositories. 👏
* [Git Cola](https://github.com/git-cola/git-cola) ⭐ 2,572 | 🐛 6 | 🌐 Python | 📅 2026-09-06 - Powerful Git GUI with a slick and intuitive user interface. 👏
...
* [OBS Studio](https://github.com/obsproject/obs-studio) ⭐ 75,975 | 🐛 1,170 | 🌐 C | 📅 2026-09-05 - Free and open source software for video recording and live streaming. 👏
* [mpv](https://github.com/mpv-player/mpv) ⭐ 36,903 | 🐛 1,145 | 🌐 C | 📅 2026-09-08 - Free, open source, and cross-platform media player. 👏
* [Kodi](https://github.com/xbmc/xbmc) ⭐ 21,191 | 🐛 476 | 🌐 C++ | 📅 2026-09-08 - Free and open source media player application. 👏
* [VLC](https://github.com/videolan/vlc) ⭐ 19,570 | 🐛 2 | 🌐 C | 📅 2026-09-08 - Free and open source cross-platform multimedia player and framework. 👏
* [SimpleScreenRecorder](https://github.com/MaartenBaert/ssr) ⭐ 2,889 | 🐛 527 | 🌐 C++ | 📅 2026-08-14 - Free and open source screen recording is easy to do. 👏
...
* [Vagrant](https://github.com/hashicorp/vagrant) ⭐ 27,207 | 🐛 752 | 🌐 Ruby | 📅 2026-09-07 - Tool for building and distributing development environments. 👏
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,695 | 🐛 0 | 🌐 C | 📅 2026-09-08 - Generic and open source machine emulator and virtualizer. 👏
* [Docker Machine](https://github.com/docker/machine) ⚠️ Archived - Machine management for a container-centric world. 👏
* [Virtual Machine Manager](https://github.com/virt-manager/virt-manager) ⭐ 3,246 | 🐛 156 | 🌐 Python | 📅 2026-09-04 - Graphical tool for managing virtual machines via libvirt. 👏
